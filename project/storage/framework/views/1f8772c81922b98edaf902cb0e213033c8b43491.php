...
<head>
  ...
  <link href="<?php echo e(asset('assets/admin/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet" type="text/css">
  <link href="<?php echo e(asset('assets/admin/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css">
...
<body id="page-top">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('admin.dashboard')); ?>">
        <div class="sidebar-brand-icon">
          <img src="<?php echo e(asset('assets/images/'.$gs->footer_logo)); ?>">
        </div>
      </a>
  ...
  <script src="<?php echo e(asset('assets/admin/jquery-easing/jquery.easing.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\property-genius\project\resources\views/layouts/admin.blade.php ENDPATH**/ ?>