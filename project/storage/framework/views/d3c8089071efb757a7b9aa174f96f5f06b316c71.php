...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="filter_search_opt">
                        <a href="javascript:void(0);" onclick="openFilterSearch()"><?php echo app('translator')->get('Search Property'); ?><i class="ml-2 ti-menu"></i></a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row gy-3">
                                    <div class="form-group">
                                        <div class="input-with-icon">
                                            <input type="text" class="form-control b-r" name="name" placeholder="<?php echo app('translator')->get('Neighborhood'); ?>" value="<?php echo e(request()->name ? request()->name : ''); ?>">
                                            <i class="ti-search"></i>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-with-icon">
                                            <select id="ptypes" class="form-control" name="category_id">
                                                ...
                                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($data->id); ?>" <?php echo e(request()->category_id == $data->id ? 'selected' : ''); ?>><?php echo e($data->title); ?></option>
                                    ...
                                    <div class="row gy-2">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <div class="input-with-icon">
                                                    <input type="text" class="form-control" name="min" value="<?php echo e(request()->min ? request()->min : ''); ?>" placeholder="<?php echo app('translator')->get('Minimum'); ?>">
                                                    <i class="ti-money"></i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <div class="input-with-icon">
                                                    <input type="text" class="form-control" name="max" value="<?php echo e(request()->max ? request()->max : ''); ?>" placeholder="<?php echo app('translator')->get('Maximum'); ?>">
                                                    <i class="ti-money"></i>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-with-icon">
                                            <input type="number" min="1" placeholder="<?php echo e(__('Enter Bed Number')); ?>" class="form-control" value="<?php echo e(request()->bed  ?request()->bed :''); ?>" name="bed" id="">
                                    ...
                                    <div class="form-group">
                                        <div class="input-with-icon">
                                            <input type="number" min="1" placeholder="<?php echo e(__('Enter Bath Number')); ?>" class="form-control" value="<?php echo e(request()->bathroom  ?request()->bathroom : ''); ?>" name="bathroom" id="">
    ...
    <form id="__search" class="d-none" action="<?php echo e(route('front.listing')); ?>" method="get">
        <input type="text" name="location" value="<?php echo e(request()->input('location') ? request()->input('location') : ''); ?>" id="location">
        <input type="text" name="type" id="type" value="<?php echo e(request()->input('type') ? request()->input('type') : ''); ?>">
        <input type="text" name="bed" id="bed" value="<?php echo e(request()->input('bed') ? request()->input('bed') : ''); ?>">
        <input type="text" name="range" id="range" value="<?php echo e(request()->input('range') ? request()->input('range') : ''); ?>">
        <input type="text" name="shorty" id="shorty_val" value="<?php echo e(request()->input('shorty') ? request()->input('shorty') : ''); ?>">
    </form>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\property-genius\project\resources\views/frontend/list.blade.php ENDPATH**/ ?>