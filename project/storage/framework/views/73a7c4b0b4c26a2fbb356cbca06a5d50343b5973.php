        ...
        <div class="order-table-wrap support-ticket-wrapper ">
            ...
            <?php echo $__env->make('includes.admin.form-both', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="panel-footer">
                    <form id="messageform" action="<?php echo e(route('admin.message.store')); ?>" data-href="<?php echo e(route('admin-message-load',$conv->id)); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\property-genius\project\resources\views/admin/message/create.blade.php ENDPATH**/ ?>