<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <ol class="breadcrumb m-0 py-0">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('agent.profile')); ?>"><?php echo e(__('Edit Profile')); ?></a></li>
        </ol>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\property-genius\project\resources\views/admin/profile.blade.php ENDPATH**/ ?>