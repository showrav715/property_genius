                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="agents-grid">
                                ...
                                <div class="agents-grid-wrap">
                                    ...
                                    <div class="fr-grid-thumb">
                                        <a href="<?php echo e(route('front.agent.details', $data->username)); ?>">
                                            <div class="overall-rate">
                                                <?php echo e(App\Models\PropertyReview::agentRatingCount($data->id)); ?></div>
                                    ...
                                    <div class="fr-grid-deatil">
                                        <h5 class="fr-can-name"><a
                                                href="<?php echo e(route('front.agent.details', $data->username)); ?>"><?php echo e($data->name); ?></a>
                                        </h5>
                                ...
                                <div class="fr-grid-footer">
                                    <a href="<?php echo e(route('front.agent.details', $data->username)); ?>"
                                        class="btn btn-outline-theme full-width"><?php echo app('translator')->get('View Profile'); ?><i
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\property_genius\project\resources\views/frontend/agents.blade.php ENDPATH**/ ?>