...
class PaytmController extends Controller
{
    ...
    function getConfigPaytmSettings() {
        ...
        define('PAYTM_MERCHANT_KEY', $paydata['secret']);
        define('PAYTM_MERCHANT_MID', $paydata['merchant']);
        define('PAYTM_MERCHANT_WEBSITE', $paydata['website']);
    ...
    public function paytmCallback( Request $request ) {
        ...
        if ( 'TXN_SUCCESS' === $request['STATUS'] ) {
            ...
            return redirect()->route('user.deposit.create')->with('message','Deposit amount '.$input['amount'].' ('.$input['currency_code'].') successfully!');

        } else if( 'TXN_FAILURE' === $request['STATUS'] ){

            return redirect()->route('user.deposit.create')->with('error', 'Payment Cancelled.');
        }
    }
