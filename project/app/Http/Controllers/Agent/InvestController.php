...
class InvestController extends Controller
{
    ...
    public function datatables(){
        $datas = Invest::orderBy('id','desc')->whereOwnerType('user')->wherePropertyOwnerId(auth()->id())->get();
        ...
        return Datatables::of($datas)
                        ...
                        ->editColumn('hold_amount', function(Invest $data){
                            return showSignAmount($data->hold_amount);
                        })
                        ->editColumn('return_amount', function(Invest $data){
                            return showSignAmount($data->return_amount);
                        })
    ...
    public function index(){
        return view('agent.invest.invest_log');
    }
    ...
    public function investdetails($id)
    {
        ...
        return view('agent.invest.details',$data);
    }
