@if(Auth::guard('admin')->user()->role_id != 0)
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Referral'))
        <li class="nav-item">
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Property Contracts'))
        <li class="nav-item">
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Manage Properties'))
        <li class="nav-item">
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Property Reviews'))
        <li class="nav-item">
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('Agent Verification'))
        <li class="nav-item">
    ...
    @if(Auth::guard('admin')->user()->sectionCheck('SMS Settings'))
        <li class="nav-item">
