...
<div class="card">
    <div class="d-sm-flex align-items-center py-3 justify-content-between">
        @if ($data->type == 'for_rent')
            <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Contract Details') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('agent.property.contracts.rents')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
        @else
            <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Contract Details') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('agent.property.contracts.sells')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
        @endif
