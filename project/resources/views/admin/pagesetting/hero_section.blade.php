      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.ps.update')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="hero_title" name="banner_title"  placeholder="{{ __('Enter About Title') }}" value="{{ $data->banner_title }}" required>
            </div>

            <div class="form-group">
                <label for="hero_subtitle">{{  __('Hero Subtitle')  }}</label>
                <input type="text" class="form-control" id="hero_subtitle" name="banner_subtitle"  placeholder="{{ __('Enter Subtitle') }}" value="{{ $data->banner_subtitle }}" required>
            </div>
