...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between">
        <h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New Property') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.invest.properties.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.invest.properties.create') }}">{{ __('Add New Property') }}</a></li>
        </ol>
	</div>
</div>
...
<div class="row justify-content-center mt-3">
  <div class="col-md-12">
    ...
    <form class="geniusform" action="{{route('admin.invest.properties.store')}}" method="POST" enctype="multipart/form-data">
