    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card h-100">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-uppercase mb-1">{{ __('Invest Properties') }}</div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ showAdminAmount($orders->sum('amount')) }} </div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ showAdminAmount($invests->sum('amount')) }} </div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-dollar-sign fa-2x text-success"></i>
                    </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ showAdminAmount($deposits->sum('amount')) }} </div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-dollar-sign fa-2x text-success"></i>
                    </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ showAdminAmount($withdrawAmount) }}</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-dollar-sign fa-2x text-success"></i>
                    </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ showAdminAmount($withdrawChargeAmount) }}</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-dollar-sign fa-2x text-success"></i>
                    </div>
            ...
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h6 mb-0 mt-2 font-weight-bold text-gray-800">{{ showAdminAmount($bonus) }}</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-dollar-sign fa-2x text-success"></i>
                    </div>
