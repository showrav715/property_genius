...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.properties.create') }}">{{ __('Add New Property') }}</a></li>
        </ol>
	</div>
</div>
...
<div class="row justify-content-center mt-3">
  <div class="col-md-12">
    ...
    <form class="geniusform" action="{{route('admin.properties.store')}}" method="POST" enctype="multipart/form-data">
