...
<div class="card">
	...
	<h5 class=" mb-0 text-gray-800 pl-3">{{ __('Add New Areas') }} <a class="btn btn-primary btn-rounded btn-sm" href="{{route('admin.areas.index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h5>
	<ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{ __('Dashboard') }}</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.areas.create') }}">{{ __('Add New Areas') }}</a></li>
	</ol>
	</div>
</div>
  ...
  <div class="col-md-10">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{route('admin.areas.store')}}" method="POST" enctype="multipart/form-data">
